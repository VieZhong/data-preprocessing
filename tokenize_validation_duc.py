...
tokenized_dir = "/data/duc/validation_json_token/tokenized"
finished_files_dir = "/data/duc/validation_json_token/"
...
def tokenize_stories(file_dir, tokenized_dir):
  ...
  for j_file in json_files:
    key_file = os.path.join(file_dir, 'gold_standard_keyphrases', j_file.split('.')[0] + '.keyphrases')
    if os.path.exists(key_file):
      names.append(j_file)
      write_file_to_tmp(os.path.join(file_dir, 'all_texts', j_file), key_file, j_file)
