...
tokenized_dir = "/data/inspec/article_tokenized"
finished_files_dir = "/data/inspec/finished_files"
...
def tokenize_stories(file_dir, tokenized_dir):
  ...
  for j_file in json_files:
    key_file = os.path.join(file_dir, 'gold_standard_test', 'test_' + j_file.split('.')[0] + '.keyphrases')
